    ...
    <div class="space-y-24">
        ...
        <section class="relative py-20 overflow-hidden">
            <div class="flex flex-col items-center text-center space-y-8 animate-reveal">
                ...
                <div class="flex flex-wrap items-center justify-center gap-6 pt-4">
                    <a href="{{ route('register') }}" class="btn btn-lg px-12 rounded-none border-2 border-cyan-600 dark:border-cyan-400 bg-cyan-600 dark:bg-cyan-400 text-white dark:text-slate-950 hover:bg-transparent hover:text-cyan-600 dark:hover:text-cyan-400 hover:border-cyan-600 dark:hover:border-cyan-400 transition-all duration-300 font-display uppercase tracking-[0.2em] shadow-md dark:shadow-[0_0_30px_rgba(34,211,238,0.4)]">
                        Enter Arena
                    </a>
                    <button class="btn btn-lg px-12 rounded-none border-2 border-slate-200 dark:border-white/20 bg-transparent text-slate-600 dark:text-white hover:border-slate-900 dark:hover:border-white transition-all duration-300 font-display uppercase tracking-[0.2em]">
                        Watch Duel
                    </button>
                </div>
            </div>
        ...
        <section id="modes">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Classic -->
                <div class="bg-white dark:cyber-glass p-6 border border-slate-200 dark:border-white/10 shadow-sm group hover:border-cyan-600 dark:hover:neon-border-cyan transition-all duration-500 cursor-pointer">
                ...
                <!-- Speed Run -->
                <div class="bg-white dark:cyber-glass p-6 border border-slate-200 dark:border-white/10 shadow-sm group hover:border-fuchsia-600 dark:hover:neon-border-magenta transition-all duration-500 cursor-pointer">
                ...
                <!-- Survival -->
                <div class="bg-white dark:cyber-glass p-6 border border-slate-200 dark:border-red-500/20 shadow-sm group hover:border-red-600 dark:hover:border-red-500 transition-all duration-500 cursor-pointer">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-12">
            <div class="lg:col-span-2 space-y-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-xs font-mono text-cyan-600 dark:text-cyan-400 hover:underline uppercase">View Full Rankings</a>
                </div>
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="font-sans">
                            <tr class="border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                <td class="p-4 font-display font-black text-cyan-600 dark:text-cyan-400">01</td>
                                <td class="p-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-cyan-100 dark:bg-cyan-500/20 border border-cyan-200 dark:border-cyan-500 flex items-center justify-center text-[10px] font-bold text-cyan-700 dark:text-cyan-400">JD</div>
                                        <span class="font-bold text-slate-900 dark:text-white">Jaxongir_Dev</span>
                                    </div>
                                </td>
                                <td class="p-4"><span class="badge badge-outline border-cyan-500/50 text-cyan-600 dark:text-cyan-400 text-[10px] uppercase">Legend</span></td>
                                <td class="p-4 font-mono text-cyan-600 dark:text-cyan-400">45,200</td>
                            </tr>
                            <tr class="border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                <td class="p-4 font-display font-black text-slate-400 dark:text-slate-500">02</td>
                                <td class="p-4 text-slate-700 dark:text-slate-300">Sardor_C++</td>
                                <td class="p-4"><span class="badge badge-outline border-fuchsia-500/50 text-fuchsia-600 dark:text-fuchsia-400 text-[10px] uppercase">Elite</span></td>
                                <td class="p-4 font-mono text-slate-600 dark:text-slate-300">42,850</td>
                            </tr>
                            <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                <td class="p-4 font-display font-black text-slate-400 dark:text-slate-500">03</td>
                                <td class="p-4 text-slate-700 dark:text-slate-300">Madina_Codes</td>
                                <td class="p-4"><span class="badge badge-outline border-slate-300 dark:border-slate-500/50 text-slate-500 dark:text-slate-400 text-[10px] uppercase">Pro</span></td>
                                <td class="p-4 font-mono text-slate-600 dark:text-slate-300">39,120</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="bg-white dark:cyber-glass-light p-4 flex gap-4 items-start border-l-2 border-cyan-600 dark:border-cyan-500 shadow-sm">
                        <div class="w-2 h-2 rounded-full bg-cyan-600 dark:bg-cyan-500 mt-1 animate-pulse"></div>
                        <div>
                            <p class="text-sm text-slate-900 dark:text-white font-medium">Jaxongir_Dev <span class="text-slate-500 dark:text-slate-400">won a Duel</span></p>
                            <p class="text-[10px] font-mono text-slate-400 dark:text-slate-500 uppercase">2 minutes ago</p>
                        </div>
                    </div>
                    <div class="bg-white dark:cyber-glass-light p-4 flex gap-4 items-start border-l-2 border-slate-300 dark:border-slate-700 shadow-sm">
                        <div class="w-2 h-2 rounded-full bg-slate-400 dark:bg-slate-700 mt-1"></div>
                        <div>
                            <p class="text-sm text-slate-900 dark:text-white font-medium">New User <span class="text-slate-400">joined the Arena</span></p>
                            <p class="text-[10px] font-mono text-slate-400 dark:text-slate-500 uppercase">15 minutes ago</p>
                        </div>
                    </div>
                </div>
            </div>
