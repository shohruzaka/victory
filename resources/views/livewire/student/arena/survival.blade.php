                ...
                <div class="cyber-glass p-8 md:p-12 space-y-12 relative overflow-hidden transition-all duration-300">
                        ...
                        @foreach($currentOptions as $index => $option)
                            ...
                            >
                                ...
                                <span wire:loading wire:target="answer({{ $option['id'] }})" class="relative z-10">
                                    <svg class="animate-spin h-4 w-4 text-red-500" viewBox="0 0 24 24">
                    ...
                    @if($showResult)
                        <div class="pt-8 border-t border-slate-100 dark:border-white/5 flex items-center justify-between animate-reveal">
                            ...
                            <button wire:click="proceed" wire:loading.attr="disabled" class="btn btn-outline {{ $isCorrect ? 'border-emerald-600 text-emerald-700 dark:border-emerald-500 dark:text-emerald-400 hover:bg-emerald-600 hover:text-white dark:hover:bg-emerald-500' : 'border-red-600 text-red-700 dark:border-red-500 dark:text-red-400 hover:bg-red-600 hover:text-white dark:hover:bg-red-500' }} rounded-none font-display uppercase tracking-widest text-xs px-8 transition-all min-w-[160px] flex items-center justify-center">
                                <span wire:loading.remove wire:target="proceed" class="flex items-center">
